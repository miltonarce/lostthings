...
=======
>>>>>>> 74eb59b719d60dd168be5f6945fadb2a19e4731d
...
angular.module('lostThings.controllers').controller('ProfileUserCtrl', ['$scope', '$state', '$stateParams', 'Authentication', 'Friends', 'Profile', 'Items', 'Utils', '$ionicLoading', function ($scope, $state, $stateParams, Authentication, Friends, Profile, Items, Utils, $ionicLoading) {
  $scope.profile = null;
  $scope.items = [];
